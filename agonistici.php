	...
	<div id="container">
		...
		<div id="main">
			<div id="menu">
				...
				<a class="menu" href="richieste.php" target="centrale">Le mie richieste</a><br>
				<a class="menu" href="imieiconcorsi.php" target="centrale">I miei concorsi</a><br>
				<a class="menu" href="orarimiei.php" target="centrale">I miei orari di allenamento</a>
			</div>
			<div id="central">
				<iframe src="orarimiei.php" name="centrale" width="992px" height="1240px" frameborder="0"></iframe>
			</div>
		</div>
	</div>
</body>
